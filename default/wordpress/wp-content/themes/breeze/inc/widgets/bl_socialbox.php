...
class bl_socialbox extends WP_Widget
{
  ...
  function form($instance){
	...
	<p>
		...
		<input type="text" style="width:100%" id="<?php echo $this->get_field_id('rss'); ?>" name="<?php echo $this->get_field_name('rss'); ?>" value="<?php echo $rss; ?>">
	</p>
	<p>
	...
	<p>
		...
		<input type="text" style="width:100%" id="<?php echo $this->get_field_id('viadeo'); ?>" name="<?php echo $this->get_field_name('viadeo'); ?>" value="<?php echo $viadeo; ?>">
	</p>
